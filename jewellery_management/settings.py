...
ALLOWED_HOSTS = ["mahaveer-jewellers-test.onrender.com", "127.0.0.1", "localhost"]
...
# Static file settings (S3 or WhiteNoise)
...
# DATABASES['default'] = dj_database_url.parse('mysql://root@localhost/jewelley_test')
